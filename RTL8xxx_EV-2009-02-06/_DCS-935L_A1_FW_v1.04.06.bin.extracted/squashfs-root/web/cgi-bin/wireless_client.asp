...
<script type="text/javascript" language="Javascript">
var g_showEffect=0;
var WirelessEnable="<% getWirelessClientInfo(Enable); %>";
var SSID="<% getWirelessClientInfo(SSID); %>";
var Mode="<% getWirelessClientInfo(Mode); %>";
var Channel="<% getWirelessClientInfo(Channel); %>";
var Authentication="<% getWirelessClientInfo(Authentication); %>";
var Encryption="<% getWirelessClientInfo(Encryption); %>";
var WepFormat="<% getWirelessClientInfo(WEPKeyFormat); %>";
var WepKeyActive="<% getWirelessClientInfo(WEPActiveKey); %>"
var WepKeyLength="<% getWirelessClientInfo(WEPKeyLength); %>";
var WepKey0="<% getWirelessClientInfo(WEPKey0); %>";
var WepKey1="<% getWirelessClientInfo(WEPKey1); %>";
var WepKey2="<% getWirelessClientInfo(WEPKey2); %>";
var WepKey3="<% getWirelessClientInfo(WEPKey3); %>";
var PreSharedKey="<% getWirelessClientInfo(PreSharedKey); %>";
...
function loadText()
{
	...
	setText(document.getElementById("sWPAPSK"), item_name[I_WPAPSK]);
	setText(document.getElementById("sWPAPSK2"), item_name[I_WPAPSK2]);
	...
	setText(document.getElementById("sTKIP"), item_name[I_TKIP]);
	setText(document.getElementById("sAES"), item_name[I_AES]);
...
function OnSelectWlan(ssid, connectMode, channel, security_mode, encryption)
{
	...
	else if (security_mode == 2)
	{
		...
		if (encryption == 1)
			...
			document.getElementsByName("radio_wpa_cipher")[1].checked = true;
		else
			document.getElementsByName("radio_wpa_cipher")[0].checked = true;
	}
	else if (security_mode == 3 || security_mode == 4)
	{
		document.getElementsByName("radio_security_mode")[3].checked = true;
		if (encryption == 1)
			document.getElementsByName("radio_wpa_cipher")[0].checked = true;
		else if (encryption == 2)
			document.getElementsByName("radio_wpa_cipher")[1].checked = true;
...
function onModeChanged()
{
	...
	{
		if (document.getElementsByName("radio_security_mode")[2].checked || document.getElementsByName("radio_security_mode")[3].checked)
			document.getElementsByName("radio_security_mode")[0].checked = true;
	}
...
function onSecurityModeChanged()
{
	if (document.getElementsByName("radio_security_mode")[0].checked)
  	...
  	else if (document.getElementsByName("radio_security_mode")[2].checked || document.getElementsByName("radio_security_mode")[3].checked)
  	{
  		$("#id_wep").hide();
...
function resetDefaultConfig()
{
	if (document.getElementById("input_wifi_enable").checked)
	{
		...
		{
			if (document.getElementsByName("radio_wpa_cipher")[0].checked)
				Encryption = "2";
			else if (document.getElementsByName("radio_wpa_cipher")[1].checked)
				Encryption = "3";
			else
				Encryption = "4";
			Authentication = "2";
		...
		else if (document.getElementsByName("radio_security_mode")[3].checked)
		{
			if (document.getElementsByName("radio_wpa_cipher")[0].checked)
				Encryption = "2";
			else if (document.getElementsByName("radio_wpa_cipher")[1].checked)
        			    ...
        			    <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF" style="display: none">
        			      ...
        			      <table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				    <TR>
        				      <TD width="180"></TD>
        				      <TD width="120px">
            				    <input type=radio name="radio_security_mode" onclick="onSecurityModeChanged();"><span id="sWPAPSK">WPA-PSK</span>
            				  </TD>
            				  <TD width="120px">
            				    <input type=radio name="radio_security_mode" onclick="onSecurityModeChanged();"><span id="sWPAPSK2">WPA2-PSK</span>
        				      </TD>
        				      <TD>
          				       <span>&nbsp;</span>
          				      </TD>
        			      ...
        			      <div id="id_wep">
      				      ...
      				      <div id="id_wpa">
        				      ...
        				      <TR>
          				        ...
          				        <TD width="120px">
            			          <input type=radio name="radio_wpa_cipher" value="0"><span id="sTKIP">TKIP</span>
            			        </TD>
            			        <TD width="120px">
            			          <input type=radio name="radio_wpa_cipher" value="1"><span id="sAES">AES</span>
          				        </TD>
          				        <TD>
          				       	  <span>&nbsp;</span>
          				      	</TD>
