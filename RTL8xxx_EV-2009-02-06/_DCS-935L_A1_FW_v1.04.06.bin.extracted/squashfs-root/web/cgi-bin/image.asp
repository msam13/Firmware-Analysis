...
<script type="text/javascript" language="Javascript">
var Contrast_Def="<% getCameraImageInfo(Contrast_Def); %>";
var Brightness_Def="<% getCameraImageInfo(Brightness_Def); %>";
var Saturation_Def="<% getCameraImageInfo(Saturation_Def); %>";
var Sharpness_Def="<% getCameraImageInfo(Sharpness_Def); %>";
var Hue_Def="<% getCameraImageInfo(Hue_Def); %>";
var Flicker_Def="<% getCameraImageInfo(Flicker_Def); %>";
var Contrast="<% getCameraImageInfo(Contrast); %>";
var Brightness="<% getCameraImageInfo(Brightness); %>";
var Saturation="<% getCameraImageInfo(Saturation); %>";
var Sharpness="<% getCameraImageInfo(Sharpness); %>";
var Hue="<% getCameraImageInfo(Hue); %>";
var Vertical="<% getCameraImageInfo(Flip); %>";
var Horizontal="<% getCameraImageInfo(Mirror); %>";
var Flicker="<% getCameraImageInfo(Flicker); %>";
var DayMode="<% getCameraImageInfo(DayMode); %>";
var MJPEG_Res="<% getVideoProfile2Info(Resolution); %>";
var MPEG4_Res="<% getVideoProfile1Info(Resolution); %>";
var H264_Res="<% getVideoProfile0Info(Resolution); %>";
...
var Clsid="<% getActiveXInfo(Clsid); %>"; 
var Cabname="<% getActiveXInfo(Cabname); %>";
var Cabname64="<% getActiveXInfo(Cabname64); %>"
var DirectshowEnable="<% getCamSystemInfo(DirectShow); %>";
var Version="<% getActiveXInfo(Version); %>";
function loadText()
{
