...
var DayMode="<% getCameraImageInfo(IRCut); %>";
var IRLEDStatus="<% getHWInfo(IRLEDStatus); %>";
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" bgcolor="#FFFFFF" onbeforeunload="uninit();">
