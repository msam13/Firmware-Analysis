...
var MDBlockEnable="<% getMDBlockInfo(Enable); %>";
var MDBlockMBlock="<% getMDBlockInfo(MBlock); %>";
var MDBlockSensitivity="<% getMDBlockInfo(Sensitivity); %>";
//var MDBlockPercentage="<% getMDBlockInfo(Percentage); %>";
