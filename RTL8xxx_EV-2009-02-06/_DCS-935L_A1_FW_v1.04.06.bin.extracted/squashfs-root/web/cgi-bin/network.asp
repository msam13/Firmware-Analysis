...
<script type="text/javascript" language="Javascript">
var g_showEffect=0;
IPv4Type="<% getIPv4Info(BootProto); %>";
IPv4PPPoEEnable="<% getIPv4Info(PPPoEEnable); %>";
IPv4IP="<% getIPv4Info(IP); %>";
IPv4Mask="<% getIPv4Info(SubnetMask); %>";
IPv4Gateway="<% getIPv4Info(Gateway); %>";
IPv4DNS1="<% getIPv4Info(DNS0); %>";
IPv4DNS2="<% getIPv4Info(DNS1); %>";
IPv4PPPoEUID="<% getIPv4Info(PPPoEUID); %>";
IPv4PPPoEPWD="<% getIPv4Info(PPPoEPWD); %>";
UPnPEnable="<% getUPnPInfo(Enable); %>";
UPnPPortForwardEnable="<% getUPnPInfo(EnablePortForward); %>";
ExternHTTP="<% getUPnPInfo(ExternHTTPPort); %>";
ExternHTTPS="<% getUPnPInfo(ExternHTTPSPort); %>";
ExternRTSP="<% getUPnPInfo(ExternRTSPPort); %>";
HTTPPort="<% getHTTPInfo(Port)%>";
RTSPPort="<% getRTSPInfo(Port)%>";
HTTPSEnable="<% getHTTPSInfo(Enable)%>";
HTTPSPort="<% getHTTPSInfo(Port)%>";
BonjourEnable="<% getBonjourInfo(Enable) %>";
BonjourName="<% getBonjourInfo(Name) %>";
function resizePage()
{
	if (parent)
	{
