...
<script type="text/javascript" language="Javascript">
var g_showEffect=0;
var H264Resolution="<% getVideoProfile0Info(Resolution); %>";
var H264Bitrate="<% getVideoProfile0Info(Bitrate); %>";
var H264FrameRate="<% getVideoProfile0Info(FrameRate); %>";
var H264RTSPURL="<% getVideoProfile0Info(RTSPURL); %>";
var MJResolution="<% getVideoProfile2Info(Resolution); %>";
var MJQuality="<% getVideoProfile2Info(Quality); %>";
var MJFrameRate="<% getVideoProfile2Info(FrameRate); %>";
var MJRTSPURL="<% getVideoProfile2Info(RTSPURL); %>";
var AudioOut="<% getHWInfo(AudioOut); %>";
var MicEnable="<% getAudioProfile0Info(MicEnable); %>";
var MicVolume="<% getAudioProfile0Info(MicVolume); %>";
var SpeakerEnable="<% getAudioProfile0Info(SpeakerEnable); %>";
var SpeakerVolume="<% getAudioProfile0Info(SpeakerVolume); %>";

var lockprofileH264="<% getMyDlinkInfo(LRCLockvProfile0); %>";
var lockprofileMJPEG="<% getMyDlinkInfo(LRCLockvProfile2); %>";
