...
var DayScheStart="<% getCameraImageInfo(IRScheEnd); %>";
var DayScheEnd="<% getCameraImageInfo(IRScheStart); %>";
function resizePage()
{
	if (parent)
	{
...
{
	DayMode = "<% getCameraImageInfo(IRCut); %>";
	DayScheStart = "<% getCameraImageInfo(IRScheEnd); %>";
	DayScheEnd = "<% getCameraImageInfo(IRScheStart); %>";
