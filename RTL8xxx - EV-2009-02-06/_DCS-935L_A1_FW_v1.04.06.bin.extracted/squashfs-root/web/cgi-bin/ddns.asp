...
var DDNSProvider="<% getDDNSInfo(PROVIDER); %>";
var DDNSProviderAddress="<% getDDNSInfo(PROVIDER_ADDRESS); %>";
var DDNSHostName="<% getDDNSInfo(HOST); %>";
var DDNSUserName="<% getDDNSInfo(UID); %>";
var DDNSPassword="<% getDDNSInfo(PWD); %>";
var DDNSTimeout="<% getDDNSInfo(Max_Interval); %>";
function resizePage()
{
	if (parent)
	{
...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" bgcolor="#FFFFFF" style="display: none">
  ...
  <iframe id="if_data" name="if_data" frameborder="0" width="0" height="0" src="ddns_data.asp" style="display: none"></iframe>
</body>
</html>
