...
<script type="text/javascript" language="Javascript">
var ScheduleReboot="<% getCamSystemInfo(ScheduleReboot); %>";
var g_showEffect=0;
...
function doFactory()
{
	var url = "/cgi/admin/hardfactorydefault.cgi";
	makeRequestByGet(url, doFactory_callback);
}
...
function doReboot()
{
	var url = "/cgi/admin/restart.cgi";
	makeRequestByGet(url, doReboot_callback);
}
