...
var IPv4Type="<% getSWIPv4Info(BootProto); %>";
var IPv4IP="<% getSWIPv4Info(IP); %>";
var IPv4Mask="<% getSWIPv4Info(SubnetMask); %>";
var IPv4Gateway="<% getSWIPv4Info(Gateway); %>";
var IPv4DNS1="<% getSWIPv4Info(DNS0); %>";
var IPv4DNS2="<% getSWIPv4Info(DNS1); %>";
var IPv4PPPoEUID="<% getSWIPv4Info(PPPoEUID); %>";
var IPv4PPPoEPWD="<% getSWIPv4Info(PPPoEPWD); %>";
var IPv4PPPoEEnable="<% getSWIPv4Info(PPPoEEnable); %>";
...
function save_setting_callback(http_request)
{
	if (http_request.readyState == 4) {
        if (http_request.status == 200) {
        	window.location.href='wizsetup3.asp';
        }else {
    	  ...
    	  <tr>
        	  ...
        	  <div id="id_lan" style="display:"><br><br>
            	  ...
            	  <center>
              		...
              		<br>
              		<br>
              		<input id="btn_back" type="button" value="Back" onclick="javascript:location.href='wizsetup.asp'">
