...
<script type="text/javascript" language="Javascript">
//for video clip
var ServerAddr="<% getEventServerFTPInfo(ServerAddr); %>";
var ServerPort="<% getEventServerFTPInfo(ServerPort); %>";
var ServerUID="<% getEventServerFTPInfo(UID); %>";
var ServerPWD="<% getEventServerFTPInfo(PWD); %>";
var ServerDIRPath="<% getEventServerFTPInfo(DIRPath); %>";
var ServerPassive="<% getEventServerFTPInfo(Passive); %>";
var Interval="<% getEventServerFTPInfo(Interval); %>";
//for snapshot
var ServerAddr_snapshot="<% getEventServerFTPSnapshotInfo(ServerAddr); %>";
var ServerPort_snapshot="<% getEventServerFTPSnapshotInfo(ServerPort); %>";
var ServerUID_snapshot="<% getEventServerFTPSnapshotInfo(UID); %>";
var ServerPWD_snapshot="<% getEventServerFTPSnapshotInfo(PWD); %>";
var ServerDIRPath_snapshot="<% getEventServerFTPSnapshotInfo(DIRPath); %>";
var ServerPassive_snapshot="<% getEventServerFTPSnapshotInfo(Passive); %>";
var Interval_snapshot="<% getEventServerFTPSnapshotInfo(Interval); %>";
    				...
    				<div id="maincontent">
        				...
        				<table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          					...
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					<INPUT type="password" size=36 maxlength=32 id="input_ftp_pwd_snapshot" name="input_ftp_pwd_snapshot" value=""></TD>
        				  </TR>
        				  <TR>
        				...
        				<table cellpadding="2" cellspacing="1" border="0" width="534" bgcolor="white" bordercolor="#FFFFFF">
        				  ...
        				  <TR>
          					...
          					<TD>
          					  <span>&nbsp;&nbsp;</span>
          					<INPUT type="password" size=36 maxlength=32 id="input_ftp_pwd" name="input_ftp_pwd" value=""></TD>
        				  </TR>
        				  <TR>
